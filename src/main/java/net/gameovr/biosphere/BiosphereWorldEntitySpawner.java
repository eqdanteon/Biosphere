...
public class BiosphereWorldEntitySpawner {
     ...
     */
    public static void performWorldGenSpawning(World worldIn, Biome biomeIn, int p_77191_2_, int p_77191_3_, int p_77191_4_, int p_77191_5_, Random randomIn, Sphere sphere)
    {
        ...
        if (!list.isEmpty())
        {
            while (randomIn.nextFloat() < biomeIn.getSpawningChance())
            {
                ...
                for (int j1 = 0; j1 < i; ++j1)
                {
                    ...
                    {
                        // this will find the top of the sphere
                        //BlockPos blockpos = worldIn.getTopSolidOrLiquidBlock(new BlockPos(j, 0, k));
                        BlockPos blockpos = new BlockPos(j, sphere.getSphereGroundLevel(), k);
